...
public class CartController {
    ...
    @PreAuthorize("hasRole('ROLE_USER')")
    @PostMapping("/add")
    public CartResponseDTO addProductIntoCart(@AuthenticationPrincipal UserDetails userDetails, @RequestBody CartRequestDTO cartRequestDTO) {
        return cartService.addProductIntoCart(userDetails, cartRequestDTO);
    }
    ...
    @PreAuthorize("hasRole('ROLE_USER')")
    @PostMapping("/remove")
    public CartResponseDTO removeProductIntoCart(@AuthenticationPrincipal UserDetails userDetails, @RequestBody CartRequestDTO cartRequestDTO) {
        return cartService.removeProductIntoCart(userDetails, cartRequestDTO);
    }
